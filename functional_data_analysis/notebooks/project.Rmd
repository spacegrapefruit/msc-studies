...
printf("Mean Absolute Error between smoothed and original data for %s: %.2f °C",
...
# cdd cluster information to the yearly data scores
...
# matrix to store the annual mean daily temperature profiles for the cluster
